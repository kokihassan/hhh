<?php
ob_start();
$dev_a = '1789306210:AAGsHbhTW9Anc40ORL_EZVp9Rf-YIJHvtJ4';
...
$bot_us = "[@$bot_us]";
if($from_id == $sudo){
if($text == "📡 وضع قناة الاشتراك الاجباري"){
	file_put_contents("set.txt","ch");
	bot('sendmessage',[
   "chat_id"=>$chat_id,
   "text"=> " 
- - حسنا $name 🦁.
الان قم بارسال معرف القناة 🎒
بدون @ 📡.
كمثال :- @cptsha8
   ",
...
if($text == "💎 ضع معرف البوت"){
	file_put_contents("botuser.txt","bot");
	bot('sendmessage',[
   "chat_id"=>$chat_id,
   "text"=> " 
حسنا مطوري $name ⚒.
- قم بارسال معرف بوتك ليتم وضعه 🛎
بدون @
   ",
   'reply_to_message_id' =>$message->message_id, 
   ]);
...
if($re and $text == "رفع مطور" || $text =="/p" and $from_id != $sudo){
    ...
    'chat_id'=>$chat_id,
    'text'=>"👤¦ العضو : $name 📡.
 ليس لديك صلاحيات رفع ، تنزيل مطور ،! ",
    'parse_mode'=>'MARKDOWN',
    'reply_to_message_id'=>$message->message_id,
  ]);
}
...
$info = "مدير الكروب 🇮🇶";
$RTBGET = "مدير الكروب 🇮🇶1";
}if($JJ117 == "creator"){
$info = "منشئ المجموعه";
$RTBGET = "منشئ المجموعه";
}if(in_array($from_id,$dev)){
$info = "مطور في البوت 🇮🇶";
$RTBGET = "مطور في البوت 🇮🇶،";
}if($from_id == $sudo){
$info = "مطور أساسي 🇮🇶";
$RTBGET = "مطور أساسي 🇮🇶";
}if(!$user){
...
if($text == "تعين الايدي" || $text == "تغير الايدي" || $text == "تعيين الايدي"){
	...
	file_put_contents("data/ids/id_.txt","ALBASHA");
	bot("sendMessage",[
	'chat_id'=>$chat_id,
	'text'=>$loran22,
	'parse_mode'=>"MARKDOWN",
...
bot('sendMessage',[
    'chat_id'=>$chat_id,
    'text'=>"
📡¦ مرحبا انٱ بوت آسـمـي ( $namebot ) 💯
🇮🇶¦ آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
🔔¦ مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...

👨🏻‍🏭¦ الـبـوت خدمـي ومتـاح للكل 👍.
مـطَور الَبــوت :- @ARLOUefg
",
...
'مرحبا'=>'[مـراحـݕ ياۿـلا┋ 💖😻](https://t.me/cptsha8)',
'هلو'=>'[هــلؤﯙؤات ﺣﻳـاﺗـﻲ 🌸??](https://t.me/cptsha8)',
...
if($text=="الاوامر" || $text =="/help"){
    bot('sendMessage',[
        'chat_id'=>$chat_id,
        'text'=>"‏‎‏📡¦ مـسـآرت آلآوآمـر آلعآمـهہ‏‏ 
...
'keyboard'=>[ 
[ 
['text'=>'📬 المشتركين،'] ,['text'=>'?? ضع كليشة المطورر'] ,['text'=>''] 
], 
[
['text'=>'🗳 اذاعه'] ,['text'=>'📆 اذاعة خاص']
], 
[ 
['text'=>'📌 عدد الكروبات'] ,['text'=>'🚀 ضع اسم للبوت'] 
], 
[ 
], 
[ 
['text'=>'📤¦ اذاعه عام'] ,['text'=>'🗂اذاعه عام بالتوجيه'] ,['text'=>'📆 اذاعة خاص توجيه'] 
], 
[ 
], 
[ 
...
[ 
['text'=>'📥 مطور السورس'] ,  ['text'=>'🗳 روابط الكروبات'] 
], 
[ 
["text"=>"🗃 تحديث الملفات"] ,['text'=>'🆔 ايدي'] ,["text"=>"📡 وضع قناة الاشتراك الاجباري"]
], 
[ 
["text"=>"™ تحديث السورس"]
], 
...
if($from_id == $sudo){
if($text=="ضع كليشه المطور" || $text == "وضع كليشه المطور" || $text == "تغير امر المطور" ||$text =="📮 ضع كليشة المطور" and $from_id == $sudo){
...
if($text == "اذاعه خاص" || $text =="📆 اذاعة خاص" and $from_id == $sudo){
    file_put_contents("Fri3nd_s/ZZ_BB.txt","ZZ_BB");
    bot('sendmessage',[
    'chat_id'=>$chat_id,
...
if($text == "اذاعه خاص بالتوجيه" || $text == "📆 اذاعة خاص توجيه" and $from_id == $sudo){
...
if($from_id == $sudo || in_array($from_id,$dev)){
if($text == "📌 عدد الكروبات" or $text == "المجموعات" || $text == "☑️¦ عدد الكروبات •"){
  $c = count($groups);
  bot('sendMessage',[
    'chat_id'=>$chat_id,
...
'reply_to_message_id'=>$message->message_id,
	...
	if($text == "™ تحديث السورس"){
	bot("SendMessage",[
	    "chat_id"=>$chat_id,
	    "text" =>"- مرحبا مطوري :- $name 📡.
- تم تحديث السورس الى اخر اصدار v12 🌝.

- تابع قناة السورس :- @cptsha8
",
		'parse_mode'=>"MARKDOWN",
         'reply_to_message_id'=>$message->message_id,
	       ]);
...
if($text == "سورس" || $text == "ياسورس" || $text == "السورس"){
		bot("sendmessage",[
	'chat_id'=>$chat_id,
	'text'=>".📡 مرحبا بك في سورس جيماكيا 🔔.

- الأول ع التلكرام 🔙 

[قناة السورس 👥.](t.me/cptsha8) 

[مطور السورس 🤖](t.me/ARLOUefg)
